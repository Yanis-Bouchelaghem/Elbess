...
export default tseslint.config(
	{
		ignores: [
			...
			'**/node_modules/',
			'**/.expo/',
			// Generated by the Better Auth CLI; hand edits would be overwritten.
			'apps/api/src/db/schema.ts',
			// React Native needs its own rules (require() for assets, etc).
			// Wire up eslint-config-expo when milestone 2 resumes.
			'apps/mobile/**',
		],
	},
	...
	{ files: ['**/*.js', '**/*.mjs'], ...tseslint.configs.disableTypeChecked },
	{
		...
		languageOptions: {
			...
			parserOptions: {
				projectService: {
					// Tool configs (drizzle.config.ts) live outside any package tsconfig.
